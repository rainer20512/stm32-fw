...
const uint8_t digits_32px_data[] = {
...
const struct font_info digits_32px = {0x44+(0x05<<8),0x1C,0x20,0x2B,0x3A,digits_32px_data,(uint8_t*)digits_32px_data+0x3A-0x2B+1};

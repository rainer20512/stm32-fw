...
const uint8_t font_proportional_16px_data[] = {
...
const struct font_info font_proportional_16px = {0x00+(0x07<<8),0x0B,0x10,0x20,0xFC,font_proportional_16px_data,(uint8_t*)font_proportional_16px_data+0xFC-0x20+1};

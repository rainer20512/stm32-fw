...
const uint8_t digits_24px_data[] = {
...
const struct font_info digits_24px = {0xAC+(0x05<<8),0x13,0x18,0x25,0xBE,digits_24px_data,(uint8_t*)digits_24px_data+0xBE -0x25+1};

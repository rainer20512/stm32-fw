...
/* ----- This file should be regarded "read only" --------------------------------------- */
    ...
    #define ADC1CH_REFINT       { ADC_CHANNEL_VREFINT,      ADC_SAMPLETIME_47CYCLES_5, NULL, 0 }
    #define ADC1CH_TEMPSENSOR   { ADC_CHANNEL_TEMPSENSOR,   ADC_SAMPLETIME_24CYCLES_5, NULL, 0 }
    #define ADC1CH_VBAT         { ADC_CHANNEL_VBAT,         ADC_SAMPLETIME_24CYCLES_5, NULL, 0 }
    ...
    #define ADC3CH_DAC1CH1      { ADC_CHANNEL_DAC1CH1_ADC3, ADC_SAMPLETIME_47CYCLES_5, NULL, 0 }
    #define ADC3CH_DAC1CH2      { ADC_CHANNEL_DAC1CH2_ADC3, ADC_SAMPLETIME_47CYCLES_5, NULL, 0 }
    #define ADC3CH_TEMPSENSOR   { ADC_CHANNEL_TEMPSENSOR,   ADC_SAMPLETIME_24CYCLES_5, NULL, 0 }
    #define ADC3CH_VBAT         { ADC_CHANNEL_VBAT,         ADC_SAMPLETIME_24CYCLES_5, NULL, 0 }
    ...
    /* The following external channels are common to ADC1 and ADC2 */
        ...
        #define ADC12_CH_6      { ADC_CHANNEL_6,  ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_1 }
        #define ADC12_CH_7      { ADC_CHANNEL_7,  ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_2 }
        #define ADC12_CH_8      { ADC_CHANNEL_8,  ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_3 }
        #define ADC12_CH_9      { ADC_CHANNEL_9,  ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_4 }
        #define ADC12_CH_10     { ADC_CHANNEL_10, ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_5 }
        #define ADC12_CH_11     { ADC_CHANNEL_11, ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_6 }
        #define ADC12_CH_12     { ADC_CHANNEL_12, ADC_SAMPLETIME_12CYCLES_5, GPIOA, GPIO_PIN_7 }
        #define ADC12_CH_13     { ADC_CHANNEL_13, ADC_SAMPLETIME_12CYCLES_5, GPIOC, GPIO_PIN_4 }
        #define ADC12_CH_14     { ADC_CHANNEL_14, ADC_SAMPLETIME_12CYCLES_5, GPIOC, GPIO_PIN_5 }
        #define ADC12_CH_15     { ADC_CHANNEL_15, ADC_SAMPLETIME_12CYCLES_5, GPIOB, GPIO_PIN_0 }
        #define ADC12_CH_16     { ADC_CHANNEL_16, ADC_SAMPLETIME_12CYCLES_5, GPIOB, GPIO_PIN_1 }
    #else
        /* The dollowing channels are specific to ADC3 in larger package types only */
        #define ADC3_CH_6       { ADC_CHANNEL_6,  ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_3 }
        #define ADC3_CH_7       { ADC_CHANNEL_7,  ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_4 }
        #define ADC3_CH_8       { ADC_CHANNEL_8,  ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_5 }
        #define ADC3_CH_9       { ADC_CHANNEL_9,  ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_6 }
        #define ADC3_CH_10      { ADC_CHANNEL_10, ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_7 }
        #define ADC3_CH_11      { ADC_CHANNEL_11, ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_8 }
        #define ADC3_CH_12      { ADC_CHANNEL_12, ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_9 }
        #define ADC3_CH_13      { ADC_CHANNEL_13, ADC_SAMPLETIME_12CYCLES_5, GPIOF, GPIO_PIN_10 }
    #endif
#endif

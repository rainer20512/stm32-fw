...
/* ----- Fixed part, don't change -------------------------------------------------- */
    ...
    #define SPI1_TX_DMA                          GET_DMA_CHANNEL(DMA_DATA_SPI1_TX), GET_DMA_REQUEST(DMA_DATA_SPI1_TX), DMA_PRIORITY_MEDIUM
    #define SPI1_RX_DMA                          GET_DMA_CHANNEL(DMA_DATA_SPI1_RX), GET_DMA_REQUEST(DMA_DATA_SPI1_RX), DMA_PRIORITY_MEDIUM
/**** 004 ****/
...
//    #define SPI1_DMA_RX_IRQHandler               DMA1_Channel2_IRQHandler
    ...
    #define SPI2_TX_DMA                          GET_DMA_CHANNEL(DMA_DATA_SPI2_TX), GET_DMA_REQUEST(DMA_DATA_SPI2_TX), DMA_PRIORITY_MEDIUM
    #define SPI2_RX_DMA                          GET_DMA_CHANNEL(DMA_DATA_SPI2_RX), GET_DMA_REQUEST(DMA_DATA_SPI2_RX), DMA_PRIORITY_MEDIUM
/**** 004 ****/
...
//    #define SPI2_DMA_RX_IRQHandler               DMA1_Channel4_IRQHandler
    ...
    #define SPI3_TX_DMA                          GET_DMA_CHANNEL(DMA_DATA_SPI3_TX), GET_DMA_REQUEST(DMA_DATA_SPI3_TX), DMA_PRIORITY_MEDIUM
    #define SPI3_RX_DMA                          GET_DMA_CHANNEL(DMA_DATA_SPI3_RX), GET_DMA_REQUEST(DMA_DATA_SPI3_RX), DMA_PRIORITY_MEDIUM
/**** 004 ****/
...
/* ----- Configurable part, change below  -------------------------------------------- */
  ...
  #endif  
  #ifdef SPI2_USE_BUSY 
    #define SPI2_BUSY                       { GPIO_PIN_8 , GPIOC, 0, GPIO_NOPULL, "Spi2_BusyIn" }
...
/* The BBSPI configuration is hardware dependent */
...
#if defined(STM32L476NUCLEO) || defined(STM32L476BAREMETAL) || defined(STM32L4S9ZXXREF)
     ...
     */
      ...
      #define SPI2_NSEL                           { GPIO_PIN_12, GPIOB, 0, GPIO_NOPULL, "BbSpi2_nSel" }
        ...
        #else
            #define SPI2_BUSY                       { GPIO_PIN_11 , GPIOB, 0, GPIO_NOPULL, "BbSpi2_BusyIn" }
        #endif
        #ifdef SPI2_USE_BUSY_IRQ

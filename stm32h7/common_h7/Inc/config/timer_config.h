...
/* ----- Fixed part, don't change -------------------------------------------------- */
        ...
        #define TIM15_CH1                         { GPIO_PIN_2,  GPIOA, GPIO_AF4_TIM15, GPIO_PULLDOWN, "Tim15_Ch1" }
        #define TIM15_CH2                         { GPIO_PIN_3,  GPIOA, GPIO_AF4_TIM15, GPIO_PULLDOWN, "Tim15_Ch2" }
        #define TIM15_CH1N                        { GPIO_PIN_1,  GPIOA, GPIO_AF4_TIM15, GPIO_PULLDOWN, "Tim15_Ch1N" }
    #elif defined(USE_TIM15_ALTN2)
        /* CH1,CH2,Ch1N : PB14,PB15, PB13  */
        #define TIM15_CH1                         { GPIO_PIN_5, GPIOE, GPIO_AF4_TIM15, GPIO_PULLDOWN, "Tim15_Ch1" }
        #define TIM15_CH2                         { GPIO_PIN_6, GPIOE, GPIO_AF4_TIM15, GPIO_PULLDOWN, "Tim15_Ch2" }
        #define TIM15_CH1N                        { GPIO_PIN_4, GPIOE, GPIO_AF4_TIM15, GPIO_PULLDOWN, "Tim15_Ch1N" }
    #else

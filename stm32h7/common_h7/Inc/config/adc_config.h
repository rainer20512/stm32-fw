...
/* ----- This file should be regarded "read only" --------------------------------------- */
    ...
    #define ADC3CH_REFINT       { ADC_CHANNEL_VREFINT,      ADC_SAMPLETIME_64CYCLES_5, NULL, 0 }
    #define ADC3CH_TEMPSENSOR   { ADC_CHANNEL_TEMPSENSOR,   ADC_SAMPLETIME_32CYCLES_5, NULL, 0 }
    #define ADC3CH_VBAT         { ADC_CHANNEL_VBAT,         ADC_SAMPLETIME_32CYCLES_5, NULL, 0 }
